            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('moduleIndex') }}">Module</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('moduleUpdate',$module->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
