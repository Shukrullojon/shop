...
<div class="wrapper" style="display: block">
	...
	<aside class="main-sidebar elevation-1 sidebar-dark-primary">
		...
		<a href="#" class="brand-link">
			<img src="{{ asset('consImages/logoU.png') }}" alt="Unired Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
			<span class="brand-text font-weight-light">DREAM</span>
		</a>
